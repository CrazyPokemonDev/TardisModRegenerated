...
public class ModWorldGen {
	...
	public static final DimensionType TARDIS_DIM_TYPE = DimensionType.register(TARDIS_NAME, "_" + TARDIS_NAME,
			TardisConfig.TARDIS_DIMENSION_TYPE_ID, WorldProviderTardis.class, TardisConfig.KEEP_DIMENSION_LOADED);
